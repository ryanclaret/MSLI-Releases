...
- **Inventory / item tracking** — record, search, and update items with full history.
- **Fleet-aware records** — inventory organized across vessels and company units. 
- **Reporting** — generate operational inventory reports and summaries. 
- **User management** — role-based access for staff. 
